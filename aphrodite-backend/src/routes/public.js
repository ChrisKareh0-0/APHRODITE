...
router.get('/products', [
  ...
  try {
    ...
    const products = await Product.find(filter)
      ...
      .select('name slug shortDescription price originalPrice images colors sizes rating isOnSale isFeatured createdAt')
      .sort(sort)
      .skip(skip)
      .limit(limit);
...
router.get('/featured', async (req, res) => {
  try {
    ...
    const products = await Product.find({
      ...
      .populate('category', 'name slug')
      .select('name slug shortDescription price originalPrice images colors sizes rating isOnSale')
      .sort({ createdAt: -1 })
      .limit(limit);
